...
public class BoardTypeAndPortNameChoseFrame {
    ...
    private void init(List<BoardType> boards, List<String> ports) {
        ...
        leftPanel.add(new JLabel("Выбирите плату:"));
        ...
        rightPanel.add(new JLabel("Выбирите порт:"));
    ...
    private void returnValue(BoardType board, String port) {
        if (board == null) {
            JOptionPane.showMessageDialog(frame, "Не выставлен флаг типа платы.", "Плата не выбрана!", JOptionPane.WARNING_MESSAGE);
